...
{{-- Page title --}}
@section('title')
    {{trans('__title.layouts.edit_client')}}
    @parent
@stop
...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{trans('__title.layouts.edit_client')}}</li>
        </ol>
    </section>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            {{trans('__title.layouts.edit_client')}}: {{$client->code}}-{{$client->name}}
                        </h3>
                    ...
                    <div class="panel-body">
                        <!--main content-->
                        <form id="commentForm" action="{{ route('admin.clients.update',$client->id) }}"
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="tab1">
                                        ...
                                        <div class="form-group {{ $errors->first('name', 'has-error') }}">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="name" name="name" type="text" placeholder="Client Name"
                                                       class="form-control required" value="{!! old('name',$client->name) !!}"/>
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" title="Select Status..." name="status">
                                                    <option value="pending"
                                                        @if(old('status',$client->status) === 'pending') selected="selected" @endif >
                                                        {{trans('__title.clients.pending')}}
                                                    </option>
                                                    <option value="resolved"
                                                        @if(old('status',$client->status) === 'resolved') selected="selected" @endif >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="date_limit" name="date_limit" type="date" class="form-control"
                                                       data-date-format="YYYY-MM-DD" value="{!! old('date_limit',$client->date_limit) !!}"/>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="money_limit" name="money_limit" type="number" min="0" class="form-control"
                                                       value="{!! old('money_limit',$client->money_limit) !!}"/>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            rows="4">{!! old('note',$client->note) !!}</textarea>
                                            </div>
